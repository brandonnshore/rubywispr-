...
- `origin/main`: `5c4619c` (`Finish release-candidate stability hardening`).
- Landed PRs in the RC stack: `#200`, `#201`, `#202`.
- Remaining open GitHub PRs checked during this pass:
  - `#191` (`Use Supabase modern API key env names`): stale, failing old checks.
  - `#192` (`RUB-26 Benchmark Groq latency and cost assumptions`): stale,
    failing old checks.
