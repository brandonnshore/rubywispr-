...
final class UpdateManager: ObservableObject {
    ...
    private func performUpdate(downloadURL: URL, expectedSize: Int) async {
        ...
        let tempDir = fm.temporaryDirectory.appendingPathComponent("rubywhisper-update-\(UUID().uuidString)")
        ...
        let dmgPath = tempDir.appendingPathComponent("RubyWhisper.dmg")
        ...
        do {
            ...
            let stagingDir = fm.temporaryDirectory.appendingPathComponent("rubywhisper-staged-\(UUID().uuidString)")
