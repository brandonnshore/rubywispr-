...
final class AudioRecorder: NSObject, ObservableObject, AVCaptureAudioDataOutputSampleBufferDelegate {
    ...
    private let sessionQueue = DispatchQueue(label: "com.rubyadvisory.rubywhisper.capture.session")
    private let sampleBufferQueue = DispatchQueue(label: "com.rubyadvisory.rubywhisper.capture.samples")
