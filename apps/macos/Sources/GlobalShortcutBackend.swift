...
private let shortcutLog = OSLog(subsystem: "com.rubyadvisory.rubywhisper", category: "Shortcuts")
...
enum GlobalShortcutBackendError: LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .eventTapUnavailable:
            return "Global shortcut monitoring could not start. \(AppName.displayName) requires Accessibility for global shortcuts."
        case .eventTapRunLoopSourceUnavailable:
