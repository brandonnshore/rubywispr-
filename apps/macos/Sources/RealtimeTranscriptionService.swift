...
private let realtimeLog = OSLog(subsystem: "com.rubyadvisory.rubywhisper", category: "RealtimeTranscription")
...
final class RealtimeTranscriptionService {
    ...
    private let stateQueue = DispatchQueue(label: "com.rubyadvisory.rubywhisper.realtime.state")
