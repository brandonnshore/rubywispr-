...
const credentialLikeValuePatterns = [
  ...
  /\b(?:CLERK_SECRET_KEY|SUPABASE_SECRET_KEY|SUPABASE_SERVICE_ROLE_KEY|DESKTOP_TOKEN_SECRET|STRIPE_SECRET_KEY|STRIPE_WEBHOOK_SECRET|GROQ_API_KEY|OPENAI_API_KEY)\b/,
